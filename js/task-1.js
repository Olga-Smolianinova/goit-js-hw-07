...
//решение
// const headingRef = document.getElementById('categories')

// console.log(`В списке ${headingRef.children.length} категории`)

// console.log(`Категория: ${headingRef.firstElementChild.children[0].textContent}`);

// console.log(`Количество элементов: ${headingRef.firstElementChild.children[1].children.length}`);
